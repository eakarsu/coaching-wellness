...
function seedDatabase() {
  ...
  const coaches = [
    { name: 'Dr. Sarah Mitchell', email: 'sarah@wellness.com', specialization: 'Weight Management', certifications: 'NASM-CPT, Precision Nutrition', experience: 12, bio: 'Specialized in sustainable weight loss', availability: 'Mon-Fri 9AM-5PM', rating: 4.9 },
    { name: 'Mike Thompson', email: 'mike@wellness.com', specialization: 'Strength Training', certifications: 'CSCS, USAW', experience: 8, bio: 'Olympic lifting specialist', availability: 'Mon-Sat 6AM-2PM', rating: 4.8 },
    { name: 'Emily Chen', email: 'emily@wellness.com', specialization: 'Yoga & Mindfulness', certifications: 'RYT-500, Meditation Teacher', experience: 10, bio: 'Holistic wellness approach', availability: 'Tue-Sun 7AM-3PM', rating: 4.95 },
    { name: 'James Rodriguez', email: 'james@wellness.com', specialization: 'Sports Nutrition', certifications: 'RD, CSSD', experience: 15, bio: 'Former Olympic athlete nutritionist', availability: 'Mon-Fri 8AM-4PM', rating: 4.85 },
    { name: 'Lisa Anderson', email: 'lisa@wellness.com', specialization: 'Rehabilitation', certifications: 'DPT, OCS', experience: 11, bio: 'Post-injury recovery specialist', availability: 'Mon-Thu 10AM-6PM', rating: 4.7 },
    ...
    { name: 'Jennifer Wu', email: 'jennifer@wellness.com', specialization: 'Plant-Based Nutrition', certifications: 'CNS, Plant-Based Pro', experience: 8, bio: 'Vegan nutrition expert', availability: 'Mon-Fri 9AM-5PM', rating: 4.7 },
    ...
    { name: 'Robert Kim', email: 'robert@wellness.com', specialization: 'Athletic Performance', certifications: 'CSCS, PES', experience: 13, bio: 'Pro athlete trainer', availability: 'Tue-Sun 5AM-1PM', rating: 4.95 },
  ...
  const clients = [
    { name: 'John Smith', email: 'john@email.com', phone: '555-0101', age: 35, gender: 'Male', goals: 'Lose 20 lbs, Build muscle', healthConditions: 'None', status: 'active' },
    { name: 'Mary Johnson', email: 'mary@email.com', phone: '555-0102', age: 42, gender: 'Female', goals: 'Improve flexibility, Reduce stress', healthConditions: 'Mild hypertension', status: 'active' },
    { name: 'Robert Davis', email: 'robert@email.com', phone: '555-0103', age: 28, gender: 'Male', goals: 'Train for marathon', healthConditions: 'None', status: 'active' },
    { name: 'Patricia Williams', email: 'patricia@email.com', phone: '555-0104', age: 55, gender: 'Female', goals: 'Maintain mobility, Bone health', healthConditions: 'Osteoporosis', status: 'active' },
    { name: 'Michael Brown', email: 'michael@email.com', phone: '555-0105', age: 31, gender: 'Male', goals: 'Gain muscle mass', healthConditions: 'None', status: 'active' },
    { name: 'Jennifer Garcia', email: 'jennifer@email.com', phone: '555-0106', age: 38, gender: 'Female', goals: 'Post-pregnancy fitness', healthConditions: 'Diastasis recti', status: 'active' },
    ...
    { name: 'David Martinez', email: 'david@email.com', phone: '555-0109', age: 52, gender: 'Male', goals: 'Manage diabetes through exercise', healthConditions: 'Type 2 Diabetes', status: 'active' },
    ...
    { name: 'Christopher Taylor', email: 'chris@email.com', phone: '555-0111', age: 40, gender: 'Male', goals: 'Increase energy levels', healthConditions: 'None', status: 'pending' },
  ...
  const wellnessGoals = [
    { clientId: clientIds[0], clientName: clients[0].name, goalType: 'Weight Loss', title: 'Lose 20 pounds', description: 'Achieve healthy weight through diet and exercise', targetValue: 180, currentValue: 195, unit: 'lbs', status: 'in_progress' },
    { clientId: clientIds[1], clientName: clients[1].name, goalType: 'Flexibility', title: 'Touch toes', description: 'Improve hamstring flexibility', targetValue: 100, currentValue: 60, unit: '% flexibility', status: 'in_progress' },
    { clientId: clientIds[2], clientName: clients[2].name, goalType: 'Endurance', title: 'Run marathon', description: 'Complete first marathon under 4 hours', targetValue: 26.2, currentValue: 15, unit: 'miles', status: 'in_progress' },
    { clientId: clientIds[3], clientName: clients[3].name, goalType: 'Strength', title: 'Improve bone density', description: 'Weight-bearing exercises for osteoporosis', targetValue: 12, currentValue: 8, unit: 'sessions/month', status: 'in_progress' },
    { clientId: clientIds[4], clientName: clients[4].name, goalType: 'Muscle Gain', title: 'Gain 15 lbs muscle', description: 'Clean bulk over 6 months', targetValue: 185, currentValue: 172, unit: 'lbs lean mass', status: 'in_progress' },
    { clientId: clientIds[5], clientName: clients[5].name, goalType: 'Recovery', title: 'Core rehabilitation', description: 'Heal diastasis recti through targeted exercises', targetValue: 1, currentValue: 2.5, unit: 'finger gap', status: 'in_progress' },
    { clientId: clientIds[6], clientName: clients[6].name, goalType: 'Health', title: 'Lower cholesterol', description: 'Reduce LDL through diet and exercise', targetValue: 100, currentValue: 145, unit: 'mg/dL', status: 'in_progress' },
    { clientId: clientIds[7], clientName: clients[7].name, goalType: 'Strength', title: 'First pull-up', description: 'Build upper body strength for unassisted pull-up', targetValue: 1, currentValue: 0, unit: 'reps', status: 'in_progress' },
    { clientId: clientIds[8], clientName: clients[8].name, goalType: 'Health', title: 'Control blood sugar', description: 'Maintain A1C below 6.5', targetValue: 6.5, currentValue: 7.2, unit: 'A1C %', status: 'in_progress' },
    { clientId: clientIds[9], clientName: clients[9].name, goalType: 'Sleep', title: 'Improve sleep quality', description: '7+ hours quality sleep per night', targetValue: 7, currentValue: 5.5, unit: 'hours', status: 'in_progress' },
    { clientId: clientIds[10], clientName: clients[10].name, goalType: 'Energy', title: 'Boost energy levels', description: 'Consistent energy throughout the day', targetValue: 8, currentValue: 4, unit: 'energy score', status: 'in_progress' },
    { clientId: clientIds[11], clientName: clients[11].name, goalType: 'Mobility', title: 'Daily movement', description: 'Walk 30 mins daily for joint health', targetValue: 30, currentValue: 15, unit: 'mins/day', status: 'in_progress' },
    { clientId: clientIds[12], clientName: clients[12].name, goalType: 'Performance', title: 'Improve vertical jump', description: 'Increase vertical leap for basketball', targetValue: 32, currentValue: 26, unit: 'inches', status: 'in_progress' },
    { clientId: clientIds[0], clientName: clients[0].name, goalType: 'Nutrition', title: 'Track macros', description: 'Consistently hit macro targets', targetValue: 30, currentValue: 22, unit: 'days streak', status: 'in_progress' },
    { clientId: clientIds[14], clientName: clients[14].name, goalType: 'Stress', title: 'Reduce stress', description: 'Lower stress through meditation and exercise', targetValue: 3, currentValue: 7, unit: 'stress level', status: 'in_progress' },
  ];
  ...
  const insertGoal = db.prepare(`
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, date('now', '-30 days'), date('now', '+60 days'), ?, '', datetime('now'), datetime('now'))
  `);

  wellnessGoals.forEach(goal => {
    insertGoal.run(uuidv4(), goal.clientId, goal.clientName, goal.goalType, goal.title, goal.description, goal.targetValue, goal.currentValue, goal.unit, goal.status);
  });
  ...
  for (let i = 0; i < 15; i++) {
    ...
    appointments.push({
      ...
      coachName: coaches[coachIndex].name,
      appointmentType: appointmentTypes[i % appointmentTypes.length],
      date: `date('now', '${dayOffset >= 0 ? '+' : ''}${dayOffset} days')`,
  ...
  appointments.forEach((appt, i) => {
    const dayOffset = Math.floor(i / 3) - 2;
    insertAppointment.run(uuidv4(), appt.clientId, appt.clientName, appt.coachName, appt.appointmentType, `${dayOffset >= 0 ? '+' : ''}${dayOffset} days`, appt.time, appt.duration, appt.status, appt.location);
  });
  ...
  for (let i = 0; i < 15; i++) {
    ...
    progressLogs.push({
      clientId: clientIds[clientIndex],
      clientName: clients[clientIndex].name,
      date: `date('now', '-${i * 3} days')`,
      weight: 150 + Math.random() * 50,
      bodyFat: 15 + Math.random() * 15,
      muscleMass: 60 + Math.random() * 30,
      waterIntake: 6 + Math.random() * 4,
      sleepHours: 5 + Math.random() * 4,
      energyLevel: Math.floor(4 + Math.random() * 6),
      stressLevel: Math.floor(2 + Math.random() * 7),
    });
  }
  ...
  progressLogs.forEach((log, i) => {
    insertProgressLog.run(uuidv4(), log.clientId, log.clientName, `-${i * 3} days`, log.weight.toFixed(1), log.bodyFat.toFixed(1), log.muscleMass.toFixed(1), log.waterIntake.toFixed(1), log.sleepHours.toFixed(1), log.energyLevel, log.stressLevel);
  });
