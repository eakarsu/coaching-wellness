...
// Gap-ai endpoint: AI adherence-prediction modeling
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('ai-adherence-prediction-modeling', body, out);
    return NextResponse.json({ feature: 'ai-adherence-prediction-modeling', title: 'AI adherence-prediction modeling', result: out });
  } catch (err: any) {
