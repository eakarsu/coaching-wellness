...
// Gap-ai endpoint: Multi-modal photo-based meal logging
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('multi-modal-photo-based-meal-logging', body, out);
    return NextResponse.json({ feature: 'multi-modal-photo-based-meal-logging', title: 'Multi-modal photo-based meal logging', result: out });
  } catch (err: any) {
