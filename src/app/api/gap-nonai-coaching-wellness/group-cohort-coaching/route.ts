...
// Gap-nonai endpoint: Group / cohort coaching
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('group-cohort-coaching', body, out);
    return NextResponse.json({ feature: 'group-cohort-coaching', title: 'Group / cohort coaching', result: out });
  } catch (err: any) {
