...
// Gap-nonai endpoint: Push-notification mobile shell
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('push-notification-mobile-shell', body, out);
    return NextResponse.json({ feature: 'push-notification-mobile-shell', title: 'Push-notification mobile shell', result: out });
  } catch (err: any) {
