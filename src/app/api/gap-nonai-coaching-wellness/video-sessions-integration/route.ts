...
// Gap-nonai endpoint: Video sessions integration
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('video-sessions-integration', body, out);
    return NextResponse.json({ feature: 'video-sessions-integration', title: 'Video sessions integration', result: out });
  } catch (err: any) {
