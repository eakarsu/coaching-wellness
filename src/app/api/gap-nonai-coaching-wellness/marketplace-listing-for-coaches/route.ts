...
// Gap-nonai endpoint: Marketplace listing for coaches
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('marketplace-listing-for-coaches', body, out);
    return NextResponse.json({ feature: 'marketplace-listing-for-coaches', title: 'Marketplace listing for coaches', result: out });
  } catch (err: any) {
