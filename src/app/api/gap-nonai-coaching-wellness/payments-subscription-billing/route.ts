...
// Gap-nonai endpoint: Payments / subscription billing
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('payments-subscription-billing', body, out);
    return NextResponse.json({ feature: 'payments-subscription-billing', title: 'Payments / subscription billing', result: out });
  } catch (err: any) {
